import{__esmMin as e,__toESM as t}from"./rolldown-runtime-cO_GjP7K.js";import{Button as n,Clarity as r,Col as i,Collapse as a,CollapseItem as o,Empty as s,Form as c,FormItem as l,Fragment as u,IQuickInputService as d,IconCloseCircle as f,IconCloseCircleFill as p,IconCommand as m,IconCopy as h,IconDelete as g,IconDown as _,IconEdit as v,IconExclamationCircleFill as y,IconEye as b,IconFile as ee,IconFilter as x,IconInfoCircle as te,IconLeft as ne,IconLock as re,IconPlus as ie,IconQuestionCircle as ae,IconSettings as oe,IconShareAlt as se,IconThunderbolt as ce,IconUnlock as le,Input as ue,KeepAlive as de,KeyCode as S,KeyMod as C,Message as w,Modal as fe,Option as pe,Popconfirm as me,Popover as he,Radio as ge,RadioGroup as _e,Row as ve,Select as ye,Split as be,Switch as xe,Textarea as Se,Tooltip as Ce,WorkerWrapper as we,WorkerWrapper$1 as Te,WorkerWrapper$2 as Ee,cloneDeep_default as De,computed as Oe,concat_default as ke,createApp as Ae,createBaseVNode as T,createBlock as E,createCommentVNode as D,createElementBlock as O,createPinia as je,createRouter as Me,createTextVNode as k,createVNode as A,createWebHashHistory as Ne,debounce_default as Pe,defineComponent as j,defineStore as Fe,editor as Ie,h as Le,init_anchorSelect as Re,init_bracketMatching as ze,init_caretOperations as Be,init_clipboard as Ve,init_codeActionContributions as He,init_codelensController as Ue,init_colorContributions as We,init_comment as Ge,init_contextmenu as Ke,init_contribution as qe,init_core as Je,init_coreCommands as Ye,init_css as Xe,init_css$1 as Ze,init_css$10 as Qe,init_css$11 as $e,init_css$12 as et,init_css$13 as tt,init_css$14 as nt,init_css$15 as rt,init_css$2 as it,init_css$3 as at,init_css$4 as ot,init_css$5 as st,init_css$6 as ct,init_css$7 as lt,init_css$8 as ut,init_css$9 as dt,init_cursorUndo as ft,init_dist as pt,init_dnd as mt,init_documentSemanticTokens as ht,init_documentSymbols as gt,init_editor_api as _t,init_editor_worker as vt,init_es as M,init_es6 as yt,init_findController as bt,init_folding as xt,init_fontZoom as St,init_formatActions as Ct,init_goToCommands as wt,init_goToDefinitionAtPosition as Tt,init_gotoError as Et,init_iPadShowKeyboard as Dt,init_icon as Ot,init_inPlaceReplace as kt,init_indentation as At,init_inlayHintsContribution as jt,init_inspectTokens as Mt,init_javascript_contribution as Nt,init_json_worker as Pt,init_lineSelection as Ft,init_linesOperations as It,init_linkedEditing as Lt,init_links as Rt,init_lodash as zt,init_longLinesHelper as Bt,init_monaco_contribution as Vt,init_monaco_contribution$1 as Ht,init_multicursor as Ut,init_parameterHints as Wt,init_pinia as Gt,init_quickInput as Kt,init_rename as qt,init_smartSelect as Jt,init_snippetController2 as Yt,init_standaloneCommandsQuickAccess as Xt,init_standaloneGotoLineQuickAccess as Zt,init_standaloneGotoSymbolQuickAccess as Qt,init_standaloneHelpQuickAccess as $t,init_standaloneReferenceSearch as en,init_stickyScrollContribution as tn,init_suggestController as nn,init_suggestInlineCompletions as rn,init_toggleHighContrast as an,init_toggleTabFocusMode as on,init_tokenization as sn,init_transpose as cn,init_ts_worker as ln,init_typescript_contribution as un,init_unicodeHighlighter as dn,init_unusualLineTerminators as fn,init_viewportSemanticTokens as pn,init_vue_router as mn,init_vue_runtime_esm_bundler as N,init_wordHighlighter as hn,init_wordOperations as gn,init_wordPartOperations as _n,inject as vn,isRef as yn,languages as P,nextTick as F,normalizeClass as bn,onBeforeUnmount as xn,onMounted as Sn,onStartTyping as Cn,onUnmounted as wn,onUpdated as Tn,openBlock as I,parse as En,provide as Dn,reactive as On,ref as L,renderList as R,renderSlot as kn,require_babel as An,require_instance as jn,resolveComponent as z,resolveDirective as Mn,resolveDynamicComponent as Nn,shallowRef as Pn,toDisplayString as B,triggerRef as Fn,unref as V,useDocumentVisibility as In,useEventListener as Ln,useRoute as Rn,useRouter as zn,useTemplateRef as Bn,useTimeoutFn as Vn,watch as H,withCtx as U,withDirectives as Hn,withModifiers as Un}from"./vendor-D5cattrk.js";var Wn=e(()=>{(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})()}),Gn=e(()=>{}),W,Kn,G=e(()=>{W=window&&window?.utools!==void 0,Kn=W?utools.isMacOS()?`darwin`:utools.isWindows()?`win32`:utools.isLinux()?`linux`:`unknown`:`unknowm`});function K(e,t){let n=JSON.stringify(t);if(W)return utools.dbStorage.setItem(e,n);localStorage.setItem(e,n)}function q(e){if(W){let t=utools.dbStorage.getItem(e);return t?JSON.parse(t):null}else{let t=localStorage.getItem(e);return t?JSON.parse(t):null}}function J(e){let t=W?utools.dbStorage:localStorage;t.removeItem(e)}function qn(e){if(W)return utools.db.allDocs(e).map(e=>({...e,value:JSON.parse(e.value)}));let t=[];if(!localStorage.length)return t;for(let n=0;n<localStorage.length;n++){let r=localStorage.key(n);if(!(e&&r&&!r.startsWith(e))&&r){let e=localStorage.getItem(r);t.push({value:e?JSON.parse(e):null,_id:r})}}return t}var Y=e(()=>{G()});function Jn(){return{name:`iife-wrap`,visitor:{Program:{exit(e){let t=e.get(`body`);if(t.length===0)return;let n=e.node.body;e.node.body=[{type:`ExpressionStatement`,expression:{type:`CallExpression`,callee:{type:`FunctionExpression`,id:null,params:[],body:{type:`BlockStatement`,body:n}},arguments:[]}}]}}}}}var Yn=e(()=>{});function Xn(e,t){let n=(0,X.transform)(e,{filename:`compiled.ts`,presets:[`typescript`],plugins:[`transform-modules-commonjs`,`babel-plugin-transform-remove-strict-mode`],...t});return n.code}function Zn(e){let t=(0,X.transform)(e,{filename:`compiled.ts`,plugins:[`transform-modules-commonjs`,`babel-plugin-iife-wrap`]});return t.code}var X,Qn=e(()=>{Yn(),X=t(An()),(0,X.registerPlugin)(`babel-plugin-transform-remove-strict-mode`,()=>({visitor:{Directive(e){e.node.value.value===`use strict`&&e.remove()}}})),(0,X.registerPlugin)(`babel-plugin-iife-wrap`,Jn)}),$n,er,tr,Z,nr=e(()=>{$n=`modulepreload`,er=function(e,t){return new URL(e,t).href},tr={},Z=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}r=o(t.map(t=>{if(t=er(t,n),t in tr)return;tr[t]=!0;let r=t.endsWith(`.css`),i=r?`[rel="stylesheet"]`:``,o=!!n;if(o)for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${t}"]${i}`))return;let s=document.createElement(`link`);if(s.rel=r?`stylesheet`:$n,r||(s.as=`script`),s.crossOrigin=``,s.href=t,a&&s.setAttribute(`nonce`,a),document.head.appendChild(s),r)return new Promise((e,n)=>{s.addEventListener(`load`,e),s.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[]){if(e.status!==`rejected`)continue;i(e.reason)}return e().catch(i)})}});async function rr(e,t){let{electron:n,Buffer:r,require:i,vm:a}=await Z(async()=>{let{electron:e,Buffer:t,require:n,vm:r}=await import(`./preload-DiKbzmox.js`);return{electron:e,Buffer:t,require:n,vm:r}},[],import.meta.url),o={console:window.__CONSOLE__,fetch:fetch.bind(window),utools:sr,electron:n,Buffer:r,require:i};try{a.createContext(o),a.runInContext(`${e}`,o)}catch(e){t&&t.error(e)}}function ir(e,t){try{let e=JSON.parse(q(`setting/importmap`));Object.assign(lr,e)}catch{w.error(`Importmap 解析失败`)}let n=e=>{if(!(e in lr))throw Error(`Module not found: ${e}`);if(e in cr)return cr[e];let t=new XMLHttpRequest;if(t.open(`GET`,lr[e],!1),t.send(),t.status===200)try{let n=Zn(t.responseText);if(!n)throw Error(`Failed to load module: ${e}`);let r={exports:{}},i=Function(`module`,`exports`,n);return i(r,r.exports),cr[e]=r.exports,r.exports}catch{}throw Error(`Failed to load module: ${e}`)};try{let t=Function(`console`,`utools`,`globalThis`,`require`,e),r=Object.assign({},globalThis);r.utools=sr,t(window.__CONSOLE__,sr,r,n)}catch(e){t&&t.error(e)}}function ar(){if(!W)return{};let e=Object.assign({},De(utools)),t=[`db`,`dbStorage`,`dbCryptoStorage`,`removeFeature`,`setFeature`,`onDbPull`],n=[`fetchUserServerTemporaryToken`,`isPurchasedUser`,`openPurchase`,`getUserServerTemporaryToken`,`openPayment`,`fetchUserPayments`],r=[`onPluginEnter`,`onPluginOut`,`onMainPush`,`createBrowserWindow`,`team`];return ke(t,n,r).forEach(t=>{delete e[t]}),Object.freeze(e),e}function or(e){let t=En(e);if(t.length){let e=t[0],n=e.tags.length?e.tags.map(t=>({name:e.description?e.description:t.tag===`name`?[t.name,t.description].join(` `):``,description:t.tag===`description`?[t.name,t.description].join(` `):``}))[0]:{name:e.description||``};return n}return null}var sr,cr,lr,ur=e(()=>{nr(),zt(),yt(),G(),Qn(),Y(),M(),rt(),sr=ar(),cr={},lr={axios:`https://cdn.jsdelivr.net/npm/axios/+esm`,jquery:`https://cdn.jsdelivr.net/npm/jquery/+esm`,lodash:`https://cdn.jsdelivr.net/npm/lodash/+esm`}}),dr,fr=e(()=>{M(),rt(),Y(),ur(),Or(),Gt(),dr=Fe(`history`,{state:()=>({historys:[]}),actions:{loadHistorys(){let e=qn(`code/`);!e||!e.length||(e.sort((e,t)=>parseInt(t._id.split(`/`)[1])-parseInt(e._id.split(`/`)[1])),this.historys=e.map(e=>{let t=e.value,n=or(t)?.name||(t.startsWith(`//`)?t.split(`
`)[0].slice(2).trim():``);return{id:e._id,timeStamp:parseInt(e._id.split(`/`)[1],10),code:e.value,name:n}}))},deleteHistory(e){let t=this.historys.findIndex(t=>t.timeStamp===e);this.historys.splice(t,1),J(`code/${e}`),w.success(`删除成功`),this.historys.length?Dr().readHistory(this.historys[0].timeStamp):Dr().newCode()}}})});function pr(e){let t=window.matchMedia(e),n=L(t.matches),r=e=>{n.value=e.matches};return t.addEventListener(`change`,r),wn(()=>{t.removeEventListener(`change`,r)}),n}var mr=e(()=>{N()});function hr(e){let t=pr(`(prefers-color-scheme: dark)`),n=pr(`(prefers-color-scheme: light)`);return Sn(()=>gr(t.value?`dark`:`light`)),H(t,t=>{gr(t?`dark`:`light`),e&&e(t?`dark`:`light`)}),[t,n]}function gr(e){if(e===`dark`)document.querySelector(`html`)?.classList.add(`dark`),document.body.setAttribute(`arco-theme`,`dark`);else if(e===`light`)document.querySelector(`html`)?.classList.remove(`dark`),document.body.removeAttribute(`arco-theme`);else{let[e]=hr();gr(e.value?`dark`:`light`)}return null}var _r=e(()=>{mr(),N()}),vr,yr=e(()=>{vr=`/// <reference path="ubw.d.ts"/>
...
`}),br,xr=e(()=>{br=`declare module 'assert' {
...
`}),Sr,Cr=e(()=>{Sr=`interface Clipboard {
...
`}),wr=e(()=>{Re(),ze(),Ye(),Be(),cn(),Ve(),He(),Ue(),We(),Ge(),Ke(),ft(),mt(),gt(),bt(),xt(),St(),Ct(),Et(),Zt(),wt(),Tt(),Dt(),kt(),At(),jt(),Mt(),Ft(),It(),Lt(),Rt(),Bt(),Ut(),Wt(),Xt(),$t(),Qt(),qe(),en(),qt(),ht(),pn(),Jt(),Yt(),tn(),nn(),rn(),an(),on(),sn(),dn(),fn(),hn(),gn(),_n(),vt(),Nt(),un(),Ht(),ln(),_t(),Vt(),Pt(),yr(),xr(),Cr(),self.MonacoEnvironment={getWorker(e,t){return t===`typescript`||t===`javascript`?new Te:t===`json`?new we:new Ee}},[`javascriptDefaults`,`typescriptDefaults`].forEach(e=>{P.typescript[e].addExtraLib(vr,`utools.api.d.ts`),P.typescript[e].addExtraLib(br,`node.api.d.ts`),P.typescript[e].addExtraLib(Sr,`electron.api.d.ts`),P.typescript[e].setDiagnosticsOptions({noSemanticValidation:!0,noSyntaxValidation:!1})}),P.typescript.javascriptDefaults.setCompilerOptions({target:P.typescript.ScriptTarget.ES2016,allowNonTsExtensions:!0,allowJs:!0}),P.json.jsonDefaults.setDiagnosticsOptions({validate:!0,schemas:[{uri:`http://myschema/dependencies.json`,fileMatch:[`*`],schema:{type:`object`,additionalProperties:{type:`string`},propertyNames:{type:`string`,pattern:`^[a-zA-Z][a-zA-Z0-9-_]*$`},minProperties:1,patternProperties:{"^.*$":{type:`string`,format:`uri`}}}}]})}),Tr,Er=e(()=>{Gt(),_r(),Y(),wr(),M(),rt(),Tr=Fe(`setting`,{state:()=>({theme:q(`setting/theme`)||`default`,snippets:[],indentType:q(`setting/indentType`)||`space`,indentSize:q(`setting/indentSize`)||2,wordWrap:q(`setting/wordWrap`)||`on`,clearConsoleBeforeRun:q(`setting/clearConsoleBeforeRun`)||!1}),actions:{init(){this.setTheme(this.theme),this.snippets=this.loadSnippets();let e=[`javascript`,`typescript`];e.forEach(e=>{P.registerCompletionItemProvider(e,{provideCompletionItems:()=>({suggestions:this.snippets.map(e=>({...e,kind:P.CompletionItemKind.Snippet,insertTextRules:P.CompletionItemInsertTextRule.InsertAsSnippet}))})})})},setTheme(e){this.theme=e,e===`default`?J(`setting/theme`):K(`setting/theme`,e),gr(e)},update(e){return t=>{this.$state[e]=t,K(`setting/${e}`,t)}},loadSnippets(){let e=qn(`setting/snippet`);return e.length?e.map(e=>({...e.value,id:e._id.split(`setting/snippet/`)[1]})):[{id:new Date().getTime().toString(),label:`clg`,insertText:"console.log(${1})",documentation:`Print to Console`}]},newSnippet(){let e={id:new Date().getTime().toString(),label:``,insertText:``,documentation:``};this.snippets.push(e),w.success(`新建成功`)},removeSnippet(e){this.snippets=this.snippets.filter(t=>t.id!==e),J(`setting/snippet/${e}`),w.success(`删除成功`)}}})}),Dr,Or=e(()=>{Gt(),M(),rt(),Y(),G(),Qn(),ur(),fr(),Er(),Dr=Fe(`CodeSrore`,{state:()=>({id:0,code:``,env:W?q(`env`)||`node`:`browser`,mode:q(`mode`)||`ontime`,language:q(`language`)||`javascript`,readonly:q(`readonly`)||!1,execState:!1}),getters:{codeWithId:e=>`code/${e.id}`,currentEnv:e=>e.env===`browser`?`浏览器`:`Node.js`,currentMode:e=>e.mode===`ontime`?`自动运行`:`手动运行`,currentReadonly:e=>e.readonly?`只读`:`可编辑`,currentLanguage:e=>e.language===`javascript`?`JavaScript`:`TypeScript`},actions:{init(){let e=q(`lastCodeId`)||0;this.loadCode(e),dr().loadHistorys()},newCode(){this.id!==0&&w.success(`成功创建新代码片段`),this.id=new Date().getTime(),this.code=q(`lastCodeId`)?``:`console.log("Hello, World!")`,K(this.codeWithId,this.code),K(`lastCodeId`,this.id),dr().loadHistorys()},loadCode(e){let t=q(`code/${e}`);if(t===null){this.newCode();return}this.id=e,this.code=t},handleCodeChange(e){this.code=e,K(this.codeWithId,this.code),this.mode===`ontime`&&this.execCode()},clearConsole(){window.__CONSOLE__.clear()},changeEnv(){if(!W)return w.warning(`当前环境不支持切换运行环境`);this.env=this.env===`browser`?`node`:`browser`,this.env===`browser`?K(`env`,`browser`):J(`env`)},changeMode(){this.mode=this.mode===`manual`?`ontime`:`manual`,this.mode===`manual`?K(`mode`,`manual`):J(`mode`)},changeReadonly(){this.readonly=!this.readonly,this.readonly?K(`readonly`,!0):J(`readonly`)},changeLanguage(){this.language=this.language===`javascript`?`typescript`:`javascript`,this.language===`typescript`?K(`language`,`typescript`):J(`language`)},readHistory(e){this.loadCode(e),K(`lastCodeId`,this.id)},execCode(e){if(e=this.code,e){Tr().clearConsoleBeforeRun&&this.clearConsole();try{let t=Xn(e);t&&(e=t+`
//# sourceURL=anonymous.js`)}catch(e){window.__CONSOLE__.error(e.message);return}this.env===`browser`?ir(e,window.__CONSOLE__):rr(e,window.__CONSOLE__),this.execState=!0,setTimeout(()=>{this.execState=!1})}}}})}),kr=e(()=>{Or(),Er()}),Ar,jr,Mr,Nr=e(()=>{Ar=Symbol(`IS_DARK`),jr=Symbol(`EVENT_FOCUS_EDITOR`),Mr=Symbol(`EVENT_SET_POSITION`)}),Pr,Fr=e(()=>{N(),kr(),Nr(),mr(),Pr=j({__name:`App`,setup(e){let t=Tr();t.init();let n=Oe(()=>{let e=pr(`(prefers-color-scheme: dark)`);return t.theme===`dark`||t.theme===`default`&&e.value});return Dn(Ar,n),(e,t)=>{let n=z(`router-view`);return I(),E(n,null,{default:U(({Component:e})=>[(I(),E(de,{include:[`Runner`]},[(I(),E(Nn(e)))],1024))]),_:1})}}})}),Ir,Lr=e(()=>{Fr(),Fr(),Ir=Pr}),Rr,zr,Br=e(()=>{nr(),mn(),Rr=Me({history:Ne(),routes:[{path:`/`,name:`Root`,redirect:`/runner`},{path:`/runner`,name:`Runner`,component:()=>Z(()=>import(`./Runner-BXzk7J4D.js`),[],import.meta.url)},{path:`/exec/:id`,name:`Exec`,component:()=>Z(()=>import(`./Exec-BqPZCxZv.js`),[],import.meta.url)},{path:`/setting`,name:`Setting`,component:()=>Z(()=>import(`./Setting-BfWD_bvX.js`),[],import.meta.url)}]}),zr=Rr});function Vr(e){e.directive(`zoom`,(e,t)=>{t.value&&(e.style.transform=`scale(1.6)`,e.style.transition=`transform 0.2s`,setTimeout(()=>{e.style.transform=`scale(1.0)`},200))})}var Hr=e(()=>{});function Ur(e){for(let t of Wr)t.name&&e.component(t.name,t)}var Wr,Gr=e(()=>{Ot(),Wr=[h,ee,te,ie,ce,oe,f,_,v,m,b,g,se,re,le,x,p,y,ae]});function Kr(e){W&&(utools.db.replicateStateFromCloud()&&w.warning({content:`数据可能不完整，还在从云端复制中`}),utools.onPluginEnter(({code:t,type:n,payload:r,option:i})=>{if(t.startsWith(`exec/`)){e.config.globalProperties.$router.push({name:`Exec`,params:{id:t.replace(`exec/`,``),mainPush:i}});return}e.config.globalProperties.$router.push({name:`Runner`})}))}var qr=e(()=>{M(),rt(),G()}),Jr=e(()=>{N(),Gn(),Lr(),Br(),Gt(),Hr(),Gr(),qr(),G(),pt(),r.init(`s71e82ng8i`,{debug:!1});try{Ae(Ir).use(zr).use(je()).use(Vr).use(Ur).use(Kr).mount(`#app`)}catch(e){console.error(e),W&&utools.showNotification(`初始化失败: `+e)}}),Yr=e(()=>{Wn(),Jr()}),Xr,Zr,Qr,$r,ei,ti,ni=e(()=>{Xr=()=>null,Zr=window?.preload?.electron||{},Qr=window?.preload?.Buffer||{},$r=window?.preload?.require||Xr,ei=window?.preload?.vm||{},ti=window?.preload?.readFileSync||Xr}),ri,ii,ai=e(()=>{N(),Y(),mn(),ri={class:`exec`},ii=j({__name:`Exec`,setup(e){let t=Rn(),n=q(`code/`+t.params.id);Sn(()=>{r()});function r(){console.log(`runCode`,n)}return(e,t)=>(I(),O(`div`,ri,B(e.$route.params.id),1))}})}),oi,si=e(()=>{ai(),ai(),oi=ii});function ci(e,t){let n=e.addCommand(0,(e,t)=>{let n=e.get(d);t(n)});e.addAction({id:`quickInput`,label:`Quick Input`,contextMenuGroupId:`buildin-action`,run:(e,{list:t,callback:r,options:i})=>{e.trigger(``,n,e=>{e.pick(t,i).then(e=>{r(e)})})}}),e.addAction({id:`run`,label:`Run`,keybindings:[C.CtrlCmd|S.KeyR,S.F5],contextMenuGroupId:`buildin-action`,run:()=>t(`action`,`runCode`)}),e.addAction({id:`newCode`,label:`New Code`,keybindings:[C.CtrlCmd|S.KeyN],contextMenuGroupId:`buildin-action`,run:()=>t(`action`,`newCode`)}),e.addAction({id:`clearConsole`,label:`Clear Console`,keybindings:[C.CtrlCmd|S.KeyK],contextMenuGroupId:`buildin-action`,run:()=>t(`action`,`clearConsole`)}),e.addAction({id:`toggleReadonly`,label:`Toggle Readonly`,keybindings:[C.CtrlCmd|S.KeyE],contextMenuGroupId:`buildin-action`,run:()=>t(`action`,`toggleReadonly`)}),e.addAction({id:`showCommands`,label:`Show Commands`,keybindings:[C.CtrlCmd|C.Shift|S.KeyP],contextMenuGroupId:`buildin-action`,run:()=>t(`action`,`showCommands`)}),e.addAction({id:`listHistory`,label:`List History`,keybindings:[C.CtrlCmd|C.Shift|S.KeyL],contextMenuGroupId:`buildin-action`,run:()=>{t(`action`,`listHistory`)}})}var li=e(()=>{wr(),Kt()}),ui,di,fi,pi=e(()=>{ui=t(jn()),di=(e,...t)=>ui.default.on(e,...t),fi=(e,...t)=>ui.default.emit(e,...t)}),mi,hi=e(()=>{N(),zt(),Je(),wr(),Nr(),li(),pi(),mi=j({__name:`Editor`,props:{code:{default:``},language:{default:`javascript`},readonly:{type:Boolean,default:!1},indentType:{default:`space`},indentSize:{default:2},wordWrap:{default:`on`},debounceInterval:{default:200}},emits:[`update:code`,`action`],setup(e,{expose:t,emit:n}){let r=e,i=n,a=L(null),o=null,s=null,c=vn(Ar),l=In();H(()=>r.code,e=>{o&&e!==o?.getValue()&&o.setValue(e)}),H(()=>r.readonly,e=>{F(()=>{o?.updateOptions({readOnly:e})})},{immediate:!0}),H(()=>r.debounceInterval,e=>{s&&(s.dispose(),s=o?.getModel()?.onDidChangeContent(Pe(()=>{i(`update:code`,o.getValue())},e))||null)},{immediate:!0}),H(()=>r.indentType,e=>{F(()=>{o?.updateOptions({insertSpaces:e===`space`})})}),H(()=>r.indentSize,e=>{F(()=>{o?.updateOptions({tabSize:e})})}),H(()=>r.wordWrap,e=>{F(()=>{o?.updateOptions({wordWrap:e})})}),H(()=>c?.value,e=>{F(()=>{Ie.setTheme(e?`vs-dark`:`vs`)})},{immediate:!0}),H(l,e=>{e&&o?.focus()}),di(jr,()=>{o?.focus()}),di(Mr,(e,t)=>{o?.setPosition({lineNumber:e,column:t})}),Sn(()=>{u()}),wn(()=>{d()}),Cn(()=>{o?.focus()}),H(()=>r.language,e=>{let t=o?.getModel();t&&Ie.setModelLanguage(t,e)},{deep:!0});function u(){o&&d(),o=Ie.create(a.value,{value:r.code,language:r.language,theme:c?.value?`vs-dark`:`vs`,tabSize:r.indentSize,insertSpaces:r.indentType===`space`,wordWrap:r.wordWrap,detectIndentation:!1,minimap:{enabled:!1},automaticLayout:!0}),ci(o,i),s=o.getModel()?.onDidChangeContent(Pe(()=>{i(`update:code`,o.getValue())},r.debounceInterval))||null,o.focus()}function d(){o?.dispose(),o=null}return t({editor:Oe(()=>o)}),(e,t)=>(I(),O(`div`,{class:`editor`,ref_key:`editorRef`,ref:a},null,512))}})}),gi=e(()=>{}),Q,$=e(()=>{Q=(e,t)=>{let n=e.__vccOpts||e;for(let[e,r]of t)n[e]=r;return n}}),_i,vi=e(()=>{hi(),hi(),gi(),$(),_i=Q(mi,[[`__scopeId`,`data-v-b1d34000`]])}),yi,bi,xi,Si,Ci,wi,Ti,Ei=e(()=>{M(),dt(),et(),ut(),N(),Nr(),pi(),Je(),yi={class:`console`},bi={class:`top-bar`},xi={class:`log-content`},Si={key:0},Ci=[`onClick`],wi={key:1},Ti=j({__name:`Console`,setup(e,{expose:t}){let r=Pn([]),i=On({}),a=On({}),o=L(``),c=Bn(`logsContainerRef`),l=L(!0),d=e=>{if(typeof e==`object`&&e)try{return JSON.stringify(e,null,2)}catch{return String(e)}return String(e)},f=e=>{let t=e.split(`
`).filter(e=>e.trim().startsWith(`at`)),n=/at\s(?:\w+\s)?\(?(.+?)(?::(\d+):(\d+))?\)?$/,r=n.exec(t[0]);if(!r)return``;let[,,i,a]=r,o=t[0].includes(`at eval`);return o?`${parseInt(i)-2}:${a}`:`${i}:${a}`},p=Oe(()=>{let e=o.value.toLowerCase();return r.value.filter(t=>e?t.type===`count`||t.type===`time`?String(t.args[0]).toLowerCase().includes(e):t.args.some(t=>String(t).toLowerCase().includes(e)):!0)}),m=(e,...t)=>{if(console[e](...t),e===`error`&&t.length===1&&Object.prototype.toString.call(t[0])===`[object Error]`){let[n]=t;r.value.push({type:e,args:[`${n.name}: ${n.message}`],timestamp:Date.now(),stack:n.stack}),Fn(r);return}r.value.push({type:e,args:t,timestamp:Date.now()}),Fn(r)},h=(...e)=>m(`log`,...e),g=(...e)=>m(`debug`,...e),_=(...e)=>m(`error`,...e),v=(...e)=>m(`warn`,...e),y=(...e)=>m(`info`,...e),b=()=>{r.value=[],Object.keys(i).forEach(e=>delete i[e]),Object.keys(a).forEach(e=>delete a[e])},ee=(e=`default`)=>{i[e]=(i[e]||0)+1,m(`count`,`${e}: ${i[e]}`)},x=(e=`default`)=>{i[e]=0},te=(e=`default`)=>{a[e]=Date.now()},ne=(e=`default`)=>{let t=a[e];if(!t){m(`error`,`Timer '${e}' does not exist`);return}let n=Date.now()-t;m(`time`,`${e}: ${n}ms`),delete a[e]},re=e=>{let[t,n]=e.split(`:`).map(e=>parseInt(e));fi(Mr,t,n),F(()=>{fi(jr)})},{start:ie,stop:ae}=Vn(()=>{l.value=!0},2e3);return Ln(c,`wheel`,()=>{l.value=!1,ae(),ie()}),Tn(()=>{F(()=>{l.value&&c.value&&(c.value.scrollTop=c.value.scrollHeight)})}),t({log:h,debug:g,error:_,warn:v,info:y,clear:b,count:ee,countReset:x,time:te,timeEnd:ne}),(e,t)=>{let r=z(`icon-filter`),i=ue,a=n,l=z(`icon-close-circle-fill`),m=z(`icon-exclamation-circle-fill`),h=s;return I(),O(`div`,yi,[T(`div`,bi,[A(i,{"model-value":o.value,"onUpdate:modelValue":t[0]||=e=>o.value=e,"allow-clear":``},{prefix:U(()=>[A(r)]),_:1},8,[`model-value`]),A(a,{onClick:b},{default:U(()=>t[1]||=[k(` 清空 `)]),_:1,__:[1]})]),p.value.length?(I(),O(`div`,{key:0,class:`logs`,ref_key:`logsContainerRef`,ref:c},[(I(!0),O(u,null,R(p.value,(e,t)=>(I(),O(`div`,{key:t,class:bn([`log-entry`,e.type])},[T(`span`,xi,[e.type===`count`||e.type===`time`?(I(),O(`span`,Si,B(e.args[0]),1)):(I(),O(u,{key:1},[e.type===`error`?(I(),E(l,{key:0,class:`prefix-icon`})):D(``,!0),e.type===`warn`?(I(),E(m,{key:1,class:`prefix-icon`})):D(``,!0),(I(!0),O(u,null,R(e.args,(e,t)=>(I(),O(`span`,{key:t,class:`log-arg`},[T(`pre`,null,B(d(e)),1)]))),128))],64))]),e.stack?(I(),O(`span`,{key:0,class:`stack`,onClick:t=>re(f(e.stack))},B(f(e.stack)),9,Ci)):D(``,!0)],2))),128))],512)):(I(),O(`div`,wi,[A(h,{style:{"margin-top":`20px`},description:`暂无日志`})]))])}}})}),Di=e(()=>{}),Oi,ki=e(()=>{Ei(),Ei(),Di(),$(),Oi=Q(Ti,[[`__scopeId`,`data-v-6475329b`]])}),Ai,ji,Mi=e(()=>{N(),G(),Ai={class:`shortcut-table`},ji=j({__name:`ShortcutGuide`,setup(e){let t=[{id:`run`,label:`运行`,keybindings:[`Ctrl+R`,`F5`],description:`运行代码`},{id:`newCode`,label:`新建代码`,keybindings:[`Ctrl+N`],description:`创建新的代码文件`},{id:`clearConsole`,label:`清空控制台`,keybindings:[`Ctrl+K`],description:`清空控制台输出`},{id:`toggleReadonly`,label:`只读模式切换`,keybindings:[`Ctrl+E`],description:`切换只读模式`},{id:`showCommands`,label:`显示命令`,keybindings:[`Ctrl+Shift+P`],description:`显示命令面板`},{id:`listHistory`,label:`历史记录`,keybindings:[`Ctrl+Shift+L`],description:`显示历史记录`}];return Kn===`darwin`&&t.forEach(e=>{e.keybindings=e.keybindings.map(e=>e.replace(`Ctrl`,`⌘`))}),(e,n)=>(I(),O(`table`,Ai,[n[0]||=T(`thead`,null,[T(`tr`,null,[T(`th`,null,`快捷键`),T(`th`,null,`描述`)])],-1),T(`tbody`,null,[(I(),O(u,null,R(t,e=>T(`tr`,{key:e.id},[T(`td`,null,[(I(!0),O(u,null,R(e.keybindings,(e,t)=>(I(),O(`span`,{key:t,class:`keybinding`},B(e),1))),128))]),T(`td`,null,B(e.description),1)])),64))])]))}})}),Ni=e(()=>{}),Pi,Fi=e(()=>{Mi(),Mi(),Ni(),$(),Pi=Q(ji,[[`__scopeId`,`data-v-7e1b1ae4`]])}),Ii,Li,Ri,zi=e(()=>{N(),Y(),vi(),Ii={class:`importmap`},Li=[`data-warning`],Ri=j({__name:`Importmap`,setup(e){let t=L(q(`setting/importmap`)||JSON.stringify({axios:`https://cdn.jsdelivr.net/npm/axios/+esm`,jquery:`https://cdn.jsdelivr.net/npm/jquery/+esm`,lodash:`https://cdn.jsdelivr.net/npm/lodash/+esm`},null,2)),n=Oe(()=>{try{return JSON.parse(t.value),!1}catch{return!0}});return H(t,e=>{try{JSON.parse(e),K(`setting/importmap`,e)}catch{}}),(e,r)=>(I(),O(`div`,Ii,[A(_i,{code:t.value,"onUpdate:code":r[0]||=e=>t.value=e,readonly:!1,"indent-size":2,language:`json`,X:``,"indent-type":`space`,"word-wrap":`on`,"data-warning":V(n)},null,8,[`code`,`data-warning`]),T(`div`,{class:`desc`,"data-warning":V(n)},B(V(n)?`JSON 格式有误，请修改后重试`:`可以在浏览器环境中使用 ES Module 的方式引入第三方库`),9,Li)]))}})}),Bi=e(()=>{}),Vi,Hi=e(()=>{zi(),zi(),Bi(),$(),Vi=Q(Ri,[[`__scopeId`,`data-v-e19b5dfa`]])}),Ui,Wi,Gi,Ki=e(()=>{M(),nt(),tt(),et(),$e(),N(),Qe(),kr(),Y(),G(),vi(),ki(),fr(),Fi(),Je(),Hi(),Ui={class:`runner`},Wi={class:`btns`},Gi=j({__name:`Runner`,setup(e){let t=Bn(`consoleRef`),r=Bn(`editorRef`),i=L(q(`size`)||.75),a=Dr(),o=Tr(),s=dr();H(t,e=>{window.__CONSOLE__=e}),Ln(`error`,e=>{e.message!==`ResizeObserver loop limit exceeded`&&window.__CONSOLE__.error(e.message)}),Ln(`unhandledrejection`,e=>{window.__CONSOLE__.error(e.reason)}),a.init(),H(i,e=>K(`size`,e));function c(){fe.open({title:`常用快捷键`,titleAlign:`start`,content:()=>Le(Pi),okButtonProps:{style:{display:`none`}}})}function l(e){switch(e){case`runCode`:a.execCode();break;case`newCode`:a.newCode();break;case`clearConsole`:a.clearConsole();break;case`toggleReadonly`:a.changeReadonly();break;case`showCommands`:r.value?.editor?.trigger(``,`editor.action.quickCommand`,null);break;case`listHistory`:s.loadHistorys();let t=s.historys.map(e=>({type:`item`,id:e.timeStamp,label:`${e.name||`Untitled`} - ${new Date(e.timeStamp).toLocaleString()} - ${e.code}`}));r.value?.editor?.focus(),r.value?.editor?.trigger(``,`quickInput`,{list:t,options:{activeItem:t[t.findIndex(e=>e.id===a.id)]},callback:e=>{e&&Dr().loadCode(e.id)}});break;default:let n=e;break}}return(e,u)=>{let d=be,f=z(`icon-plus`),p=n,m=z(`icon-thunderbolt`),h=z(`icon-lock`),g=z(`icon-unlock`),_=z(`icon-settings`),v=z(`icon-delete`),y=me,b=z(`icon-question-circle`),ee=he,x=Mn(`zoom`);return I(),O(`div`,Ui,[A(d,{size:V(i),"onUpdate:size":u[0]||=e=>yn(i)?i.value=e:null,min:.1,max:.8},{first:U(()=>[A(_i,{ref_key:`editorRef`,ref:r,code:V(a).code,language:V(a).language,readonly:V(a).readonly,"indent-type":V(o).indentType,"indent-size":V(o).indentSize,"word-wrap":V(o).wordWrap,"onUpdate:code":V(a).handleCodeChange,onAction:l},null,8,[`code`,`language`,`readonly`,`indent-type`,`indent-size`,`word-wrap`,`onUpdate:code`])]),second:U(()=>[A(Oi,{ref_key:`consoleRef`,ref:t},null,512)]),_:1},8,[`size`]),T(`div`,Wi,[T(`div`,null,[A(p,{title:`新建代码`,onClick:V(a).newCode},{default:U(()=>[A(f)]),_:1},8,[`onClick`]),A(p,{title:`运行代码`,onClick:u[1]||=()=>V(a).execCode()},{default:U(()=>[Hn(A(m,null,null,512),[[x,V(a).execState]])]),_:1}),A(p,{title:`清空控制台`,onClick:V(a).changeReadonly},{default:U(()=>[V(a).readonly?Hn((I(),E(h,{key:0},null,512)),[[x,V(a).readonly]]):Hn((I(),E(g,{key:1},null,512)),[[x,!V(a).readonly]])]),_:1},8,[`onClick`]),A(p,{title:`设置`,onClick:u[2]||=t=>e.$router.push(`/setting`)},{default:U(()=>[A(_)]),_:1}),A(y,{content:`确定删除当前代码片段吗？`,onOk:u[4]||=e=>V(s).deleteHistory(V(a).id)},{default:U(()=>[A(p,{title:`删除`,onClick:u[3]||=Un(t=>e.void,[`stop`])},{default:U(()=>[A(v)]),_:1})]),_:1}),A(p,{title:`常用快捷键`,onClick:c},{default:U(()=>[A(b)]),_:1})]),T(`div`,null,[A(ee,{trigger:`click`},{content:U(()=>[A(Vi)]),default:U(()=>[V(a).env===`browser`?(I(),E(p,{key:0},{default:U(()=>u[6]||=[k(` Importmap `)]),_:1,__:[6]})):D(``,!0)]),_:1}),V(W)?(I(),E(p,{key:0,class:`width-80`,onClick:V(a).changeEnv},{default:U(()=>[k(B(V(a).currentEnv),1)]),_:1},8,[`onClick`])):D(``,!0),A(p,{class:`width-80`,onClick:V(a).changeMode},{default:U(()=>[k(B(V(a).currentMode),1)]),_:1},8,[`onClick`]),A(p,{class:`width-80`,onClick:V(a).changeLanguage},{default:U(()=>[k(B(V(a).currentLanguage),1)]),_:1},8,[`onClick`]),A(p,{onClick:u[5]||=e=>l(`listHistory`)},{default:U(()=>[k(` 历史 (`+B(V(s).historys.length)+`) `,1)]),_:1})])])])}}})}),qi=e(()=>{}),Ji,Yi=e(()=>{Ki(),Ki(),qi(),$(),Ji=Q(Gi,[[`__scopeId`,`data-v-ff74307c`]])});function Xi(){let e=zn(),t=()=>e.back();return Ln(document,`keydown`,e=>{e.key===`Escape`&&(t(),e.stopPropagation())}),{BackButton:()=>Le(n,{onClick:t,shape:`circle`,style:{position:`fixed !important`,top:`10px`,left:`10px`}},()=>Le(ne))}}var Zi=e(()=>{M(),et(),Ot(),Je(),mn(),N()}),Qi,$i,ea,ta=e(()=>{M(),Xe(),N(),Qi={class:`setting-content`},$i={key:0,class:`title`},ea=j({__name:`SettingContent`,props:{title:{},desc:{}},setup(e){return(e,t)=>{let n=z(`icon-info-circle`),r=Ce;return I(),O(`div`,Qi,[e.title?(I(),O(`h3`,$i,B(e.title),1)):D(``,!0),e.desc?(I(),E(r,{key:1,content:e.desc},{default:U(()=>[A(n)]),_:1},8,[`content`])):D(``,!0),kn(e.$slots,`default`)])}}})}),na=e(()=>{}),ra,ia=e(()=>{ta(),ta(),na(),ra=ea}),aa,oa,sa,ca,la,ua,da,fa,pa=e(()=>{M(),lt(),tt(),et(),ct(),st(),ot(),ut(),at(),it(),Ze(),N(),Zi(),ia(),kr(),Y(),aa={class:`setting`},oa={class:`setting-item`},sa={class:`setting-item`},ca={class:`setting-item`},la={class:`setting-item`},ua={class:`setting-item`},da={class:`setting-item`},fa=j({__name:`Setting`,setup(e){let t=Tr(),{BackButton:r}=Xi();return xn(()=>{for(let e of t.snippets)K(`setting/snippet/`+e.id,e)}),(e,s)=>{let d=ge,f=_e,p=pe,m=ye,h=xe,g=ue,_=l,v=i,y=ve,b=Se,ee=c,x=z(`icon-delete`),te=n,ne=me,re=o,ie=a;return I(),O(`div`,aa,[A(V(r)),A(ra,{title:`编辑器设置`},{default:U(()=>[T(`div`,oa,[s[11]||=T(`h4`,null,`代码缩进`,-1),A(f,{modelValue:V(t).indentType,"onUpdate:modelValue":s[0]||=e=>V(t).indentType=e,onChange:s[1]||=e=>V(t).update(`indentType`)(e)},{default:U(()=>[A(d,{value:`space`},{default:U(()=>s[9]||=[k(`Space`)]),_:1,__:[9]}),A(d,{value:`tab`},{default:U(()=>s[10]||=[k(`Tab`)]),_:1,__:[10]})]),_:1},8,[`modelValue`])]),T(`div`,sa,[s[16]||=T(`h4`,null,`缩进尺寸`,-1),A(m,{modelValue:V(t).indentSize,"onUpdate:modelValue":s[2]||=e=>V(t).indentSize=e,onChange:s[3]||=e=>V(t).update(`indentSize`)(e)},{default:U(()=>[A(p,{value:2},{default:U(()=>s[12]||=[k(`2`)]),_:1,__:[12]}),A(p,{value:4},{default:U(()=>s[13]||=[k(`4`)]),_:1,__:[13]}),A(p,{value:6},{default:U(()=>s[14]||=[k(`6`)]),_:1,__:[14]}),A(p,{value:8},{default:U(()=>s[15]||=[k(`8`)]),_:1,__:[15]})]),_:1},8,[`modelValue`])]),T(`div`,ca,[s[17]||=T(`h4`,null,`自动换行`,-1),A(h,{"model-value":V(t).wordWrap===`on`,onChange:s[4]||=e=>V(t).update(`wordWrap`)(e?`on`:`off`)},null,8,[`model-value`])]),T(`div`,la,[s[19]||=T(`h4`,null,`自定义代码片段`,-1),V(t).snippets.length?(I(),E(ie,{key:0},{default:U(()=>[(I(!0),O(u,null,R(V(t).snippets,n=>(I(),E(re,{key:n.id,header:`Snippet: ${n.label} - ${n.documentation}`},{extra:U(()=>[A(ne,{content:`确定删除吗？`,onOk:e=>V(t).removeSnippet(n.id)},{default:U(()=>[A(te,{onClick:s[5]||=Un(t=>e.void,[`stop`]),status:`danger`,shape:`circle`},{default:U(()=>[A(x)]),_:1})]),_:2},1032,[`onOk`])]),default:U(()=>[A(ee,{model:n,layout:`vertical`},{default:U(()=>[A(y,null,{default:U(()=>[A(v,{span:12},{default:U(()=>[A(_,{field:`label`,label:`提示词`,required:``},{default:U(()=>[A(g,{modelValue:n.label,"onUpdate:modelValue":e=>n.label=e,placeholder:`label`},null,8,[`modelValue`,`onUpdate:modelValue`])]),_:2},1024)]),_:2},1024),A(v,{span:12},{default:U(()=>[A(_,{field:`documentation`,label:`说明`},{default:U(()=>[A(g,{modelValue:n.documentation,"onUpdate:modelValue":e=>n.documentation=e,placeholder:`documentation`},null,8,[`modelValue`,`onUpdate:modelValue`])]),_:2},1024)]),_:2},1024)]),_:2},1024),A(y,null,{default:U(()=>[A(v,{span:24},{default:U(()=>[A(_,{field:`insertText`,label:`代码内容`,required:``},{default:U(()=>[A(b,{modelValue:n.insertText,"onUpdate:modelValue":e=>n.insertText=e,placeholder:`insertText`},null,8,[`modelValue`,`onUpdate:modelValue`])]),_:2},1024)]),_:2},1024)]),_:2},1024)]),_:2},1032,[`model`])]),_:2},1032,[`header`]))),128))]),_:1})):D(``,!0),A(te,{type:`outline`,onClick:Un(V(t).newSnippet,[`stop`]),style:{"margin-top":`10px`},long:``},{default:U(()=>s[18]||=[k(` 新建 `)]),_:1,__:[18]},8,[`onClick`])])]),_:1}),A(ra,{title:`运行设置`},{default:U(()=>[T(`div`,ua,[s[20]||=T(`h4`,null,`运行前清空控制台`,-1),A(h,{"model-value":V(t).clearConsoleBeforeRun,onChange:s[6]||=e=>V(t).update(`clearConsoleBeforeRun`)(e)},null,8,[`model-value`])])]),_:1}),A(ra,{title:`插件设置`},{default:U(()=>[T(`div`,da,[s[24]||=T(`h4`,null,`偏好主题`,-1),A(f,{modelValue:V(t).theme,"onUpdate:modelValue":s[7]||=e=>V(t).theme=e,onChange:s[8]||=e=>V(t).setTheme(e)},{default:U(()=>[A(d,{value:`default`},{default:U(()=>s[21]||=[k(`跟随系统`)]),_:1,__:[21]}),A(d,{value:`dark`},{default:U(()=>s[22]||=[k(`深色模式`)]),_:1,__:[22]}),A(d,{value:`light`},{default:U(()=>s[23]||=[k(`浅色模式`)]),_:1,__:[23]})]),_:1},8,[`modelValue`])])]),_:1})])}}})}),ma=e(()=>{}),ha,ga=e(()=>{pa(),pa(),ma(),$(),ha=Q(fa,[[`__scopeId`,`data-v-5fbc9657`]])});export{Qr as Buffer,oi as Exec_default,Ji as Runner_default,ha as Setting_default,Z as __vitePreload,Zr as electron,si as init_Exec,Yi as init_Runner,ga as init_Setting,Yr as init_SuperJavaScript,ni as init_preload,nr as init_preload_helper,$r as require,ei as vm};